...
import { ArrowRight, MessageCircle, Phone, Menu, X, Bell ,Loader2 } from "lucide-react";
...
export default function Hero() {
  // ✅ Estados do menu mobile e interface
...
// ✅ Estados do Chatbot + Status
const [messages, setMessages] = useState<Message[]>([
  { from: "bot", text: "Olá! 👋 Sou o assistente virtual da Horizon. Como posso ajudar você hoje?" }
]);
...
const sendMessage = () => {
  ...
  if (!isConnected) {
    alert("Conectando... Aguarde um momento.");
    return;
  }
...
<div className="mt-4 space-y-3">
  ...
  {/* ✅ Indicador de Status "Pensando... Escrevendo..." */}
  {isTyping && statusMessage && (
    <div className="flex justify-start">
      <div className="bg-gray-100 text-gray-600 px-4 py-2 rounded-2xl flex items-center gap-2">
